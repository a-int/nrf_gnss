...
The CUSTOM_cpuapp build target provides support for the application
core on the nRF5340 SoC. The CUSTOM_cpunet build target provides
...
The CUSTOM_cpuapp board configuration supports the following
hardware features:
...
The CUSTOM_cpunet board configuration supports the following
hardware features:
...
Applications built for the CUSTOM_cpuapp board by default
...
1. Build the Non-Secure Zephyr application
   for the application core using ``-DBOARD=CUSTOM_cpuapp_ns``.
...
1. Build the Secure Zephyr application for the application core
   using ``-DBOARD=CUSTOM_cpuapp`` and
...
and :ref:`application_run`), using ``-DBOARD=CUSTOM_cpuapp`` for
the firmware running on the nRF5340 application core, and using
``-DBOARD=CUSTOM_cpunet`` for the firmware running
...
:zephyr_file:`boards/arm/CUSTOM/nrf5340_cpuapp_common.dtsi`.
